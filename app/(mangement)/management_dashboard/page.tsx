  ...
  return (
    <div className="flex flex-col gap-8">
            ...
            {casesByType.map((item) => {
              ...
              return (
                <div key={item.type} className="flex items-center gap-3">
                  <span
                    className={cn(
                      "inline-flex px-2 py-0.5 rounded-full text-xs font-medium shrink-0 w-24 sm:w-36",
                      item.light,
                      item.text
                    )}
                  >
              ...
              .map((w) => {
                ...
                return (
                  <div key={w.name} className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-textSecondary w-12 sm:w-16 shrink-0">
                      {w.name}
                    </span>
                    <div className="flex-1 bg-borderPrimary rounded-full h-2 overflow-hidden">
                      <div
      ...
      <div className="rounded-2xl bg-backgroundSecondary border border-borderPrimary p-6 shadow-sm">
        ...
        {/* Summary row */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 pt-5 border-t border-borderPrimary">
          <div>
